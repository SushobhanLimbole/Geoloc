...
class AttendanceMap extends StatefulWidget {
  AttendanceMap({required this.isAdmin,required this.userName,required this.userEmail});

  final bool isAdmin;
  final String userName;
  final String userEmail;
  @override
  _AttendanceMapState createState() => _AttendanceMapState(this.isAdmin,this.userName,this.userEmail);
}
